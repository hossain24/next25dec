      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 font-serif">
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-sm/6 font-semibold text-slate-500">
              Product
              <ChevronDownIcon aria-hidden="true" className="size-5 flex-none text-slate-500" />
            </PopoverButton>
                ...
                {products.map((item) => (
                  ...
                  >
                    <div className="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-700/50 group-hover:bg-gray-700">
                      <item.icon aria-hidden="true" className="size-6 text-slate-500 group-hover:text-white" />
                    </div>
                    <div className="flex-auto">
                      <a href={item.href} className="block font-semibold text-slate-500">
                        {item.name}
              ...
              <div className="grid grid-cols-2 divide-x divide-white/10 bg-gray-700/50">
                {callsToAction.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 font-semibold text-slate-500 hover:bg-gray-700/50"
                  >
                    <item.icon aria-hidden="true" className="size-5 flex-none text-slate-500" />
                    {item.name}
                  </a>
                ))}
              </div>
          ...
          <a href="#" className="text-sm/6 font-semibold text-slate-500">
            Features
          </a>
          <a href="#" className="text-sm/6 font-semibold text-slate-500">
            Marketplace
