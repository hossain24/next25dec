    ...
    <section className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl lg:max-w-4xl">
        ...
        <figure className="mt-10">
          <blockquote className="text-center text-xl/8 font-semibold text-slate-700 sm:text-2xl/9 italic font-serif">
            <p>"Read for your self to enrich your knowledge and experience."</p>
          </blockquote>
